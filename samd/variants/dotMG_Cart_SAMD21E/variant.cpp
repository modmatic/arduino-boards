...
const PinDescription g_APinDescription[]=
{
  ...
  // I2C
  // --------------------
  /* ~D1/A1        */ { PORTA, 10, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_ANALOG|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), ADC_Channel18, PWM0_CH2, TCC0_CH2, EXTERNAL_INT_10 }, // ADC/AIN[18], TCC0/WO[2], SDA: SERCOM0/PAD[2]
  /* ~D2/A2        */ { PORTA, 11, PIO_SERCOM, (PIN_ATTR_DIGITAL|PIN_ATTR_ANALOG|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), ADC_Channel19, PWM0_CH3, TCC0_CH3, EXTERNAL_INT_11 }, // ADC/AIN[19], TCC0/WO[3], SCL: SERCOM0/PAD[3]
